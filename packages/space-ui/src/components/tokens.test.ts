...
export const EXPECTED_TOKENS = [
  ...
  "--sp-grid-base-size",
  "--sp-chart-series-1-color", "--sp-chart-series-2-color", "--sp-chart-series-3-color",
  "--sp-chart-series-4-color", "--sp-chart-series-5-color", "--sp-chart-series-6-color",
  "--sp-chart-series-7-color", "--sp-chart-series-8-color",
  "--sp-chart-grid-color", "--sp-chart-axis-color", "--sp-chart-label-color",
  "--sp-chart-track-color", "--sp-chart-mark-radius-size", "--sp-chart-line-width",
  "--sp-bar-list-label-width", "--sp-bar-list-track-height", "--sp-pie-chart-gap-size",
